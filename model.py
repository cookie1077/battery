...
class RNN_GRU(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, layers):
        ...
        self.rnn = torch.nn.GRU(input_dim, hidden_dim, num_layers=layers, batch_first=True, dropout=0.5)
        self.ReLU = nn.ReLU()
...
class RNN_LSTM(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, layers):
        ...
        self.rnn = torch.nn.LSTM(input_dim, hidden_dim, num_layers=layers, batch_first=True, dropout=0.5)
        self.ReLU = nn.ReLU()
        self.dropout = nn.Dropout(0.5)
        self.fc1 = torch.nn.Linear(hidden_dim, 20, bias=True)
        self.fc2 = torch.nn.Linear(20, 30, bias=True)
